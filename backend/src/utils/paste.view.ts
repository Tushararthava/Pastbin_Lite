...
// Read HTML template from views folder
...
// Language class mapping for Prism.js
const languageClassMapping: Record<string, string> = {
    plaintext: 'plaintext',
    javascript: 'javascript',
    typescript: 'typescript',
    python: 'python',
...
export function generatePasteHtml(data: PasteData): string {
...
export function generate404Html(message: string = 'Paste not found'): string {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
